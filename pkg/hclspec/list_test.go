...
func TestListCtyType(t *testing.T) {
	tests := []struct {
		...
		{
			name:     "list of 8-bit integers",
			list:     List(Int8()),
			expected: cty.List(cty.Number),
		},
		{
			name:     "list of 16-bit integers",
			list:     List(Int16()),
			expected: cty.List(cty.Number),
		},
		{
			name:     "list of 32-bit integers",
			list:     List(Int32()),
			expected: cty.List(cty.Number),
		},
		{
			name:     "list of 64-bit integers",
			list:     List(Int64()),
			expected: cty.List(cty.Number),
		},
		{
			name:     "list of 8-bit unsigned integers",
			list:     List(UInt8()),
			expected: cty.List(cty.Number),
		},
		{
			name:     "list of 16-bit unsigned integers",
			list:     List(UInt16()),
			expected: cty.List(cty.Number),
		},
		{
			name:     "list of 32-bit unsigned integers",
			list:     List(UInt32()),
			expected: cty.List(cty.Number),
		},
		{
			name:     "list of 64-bit unsigned integers",
			list:     List(UInt64()),
			expected: cty.List(cty.Number),
		},
		{
			name:     "list of 32-bit floating-point numbers",
			list:     List(Float32()),
			expected: cty.List(cty.Number),
		},
		{
			name:     "list of 64-bit floating-point numbers",
			list:     List(Float64()),
			expected: cty.List(cty.Number),
		},
		{
...
func TestListConvert_InvalidValues(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			input: cty.TupleVal([]cty.Value{
				cty.NumberIntVal(42),
				cty.ListVal([]cty.Value{cty.NumberIntVal(314)}),
			}),
		},
		{
