...
func TestEncodeAsUTF16LEBase64(t *testing.T) {
	tests := []struct {
		name     string
		input    string
		expected string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result, err := EncodeAsUTF16LEBase64(tt.input)
			if err != nil {
				t.Fatalf("EncodeAsUTF16LEBase64() error = %v", err)
			}
...
func TestEncodeAsUTF16LEBase64_EmptyString(t *testing.T) {
	_, err := EncodeAsUTF16LEBase64("")
	if err == nil {
...
func TestEncodeAsUTF16LEBase64_WhitespaceOnly(t *testing.T) {
	...
	for _, input := range whitespaceInputs {
		t.Run(fmt.Sprintf("whitespace_%q", input), func(t *testing.T) {
			result, err := EncodeAsUTF16LEBase64(input)
			if err != nil {
...
func TestEncodeAsUTF16LEBase64_LongScript(t *testing.T) {
...
`
	...
	result, err := EncodeAsUTF16LEBase64(longScript)
	if err != nil {
		t.Fatalf("EncodeAsUTF16LEBase64() error = %v", err)
	}
...
func TestEncodeAsUTF16LEBase64_SpecialCharacters(t *testing.T) {
...
"@`, // Here-strings
	...
	for i, testCase := range testCases {
		t.Run(fmt.Sprintf("special_chars_%d", i), func(t *testing.T) {
			result, err := EncodeAsUTF16LEBase64(testCase)
			if err != nil {
				t.Fatalf("EncodeAsUTF16LEBase64() error = %v", err)
			}
