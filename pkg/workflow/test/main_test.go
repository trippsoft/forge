...
func (e *expectedEscalation) verify(t *testing.T, actual *workflow.StepEscalationConfig) {

	if actual == nil {
		t.Fatal("expected step escalation config to be non-nil, got nil")
	}
...
func (e *expectedStep) verify(t *testing.T, a workflow.Step) {
	...
	actualEscalation := actual.Escalation()
	if e.escalation != nil {
