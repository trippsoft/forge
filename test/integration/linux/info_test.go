...
func TestHostInfo(t *testing.T) {
		...
		},
		{
			...
			expected: integration.ExpectedHostInfo{
				OS: integration.ExpectedOSInfo{
					...
					Kernel:       "linux",
					Id:           "rocky",
					FriendlyName: "Rocky Linux 10.1 (Red Quartz)",
					Release:      "",
					ReleaseId:    "",
					MajorVersion: "10",
					Version:      "10.1",
		...
		},
		{
			...
			expected: integration.ExpectedHostInfo{
				OS: integration.ExpectedOSInfo{
					...
					Kernel:       "linux",
					Id:           "rocky",
					FriendlyName: "Rocky Linux 9.7 (Blue Onyx)",
					Release:      "",
					ReleaseId:    "",
					MajorVersion: "9",
					Version:      "9.7",
		...
		},
		{
			...
			expected: integration.ExpectedHostInfo{
				OS: integration.ExpectedOSInfo{
					...
					Kernel:       "linux",
					Id:           "ubuntu",
					FriendlyName: "Ubuntu 24.04.4 LTS",
					Release:      "noble",
					ReleaseId:    "noble",
					MajorVersion: "24",
					Version:      "24.04",
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if result.Error != nil {
				t.Fatalf("failed to populate host info via SSH: %v", result.Error)
			}
