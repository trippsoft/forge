...
CGO_ENABLED=0 GOOS=windows GOARCH=amd64 go build -o ./plugins/forge/discover/forge-discover_windows_amd64.exe ../../../cmd/forge-discover
CGO_ENABLED=0 GOOS=windows GOARCH=arm64 go build -o ./plugins/forge/discover/forge-discover_windows_arm64.exe ../../../cmd/forge-discover
...
CGO_ENABLED=0 GOOS=windows GOARCH=amd64 go build -o ./plugins/forge/core/forge-core_windows_amd64.exe ../../../cmd/forge-core
CGO_ENABLED=0 GOOS=windows GOARCH=arm64 go build -o ./plugins/forge/core/forge-core_windows_arm64.exe ../../../cmd/forge-core
